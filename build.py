...
def build_flutter_dmg(version, features):
    ...
    '''
    system2(
        "create-dmg --volname \"SAKURA-Remote Installer\" --window-pos 200 120 --window-size 800 400 --icon-size 100 --app-drop-link 600 185 --icon SAKURA-Remote.app 200 190 --hide-extension SAKURA-Remote.app SAKURA-Remote.dmg ./build/macos/Build/Products/Release/SAKURA-Remote.app")
    os.rename("SAKURA-Remote.dmg", f"../SAKURA-Remote-{version}.dmg")
    '''
    os.chdir("..")
