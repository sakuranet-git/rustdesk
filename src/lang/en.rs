...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the SAKURA-Remote network..."),
        ...
        ("Slogan_tip", "SAKURA-Remote — Simple and secure remote support"),
        ...
        ("install_tip", "Due to UAC, SAKURA-Remote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install SAKURA-Remote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant SAKURA-Remote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant SAKURA-Remote \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow SAKURA-Remote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [SAKURA-Remote Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next SAKURA-Remote application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant SAKURA-Remote \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant SAKURA-Remote \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running SAKURA-Remote."),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use SAKURA-Remote and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade SAKURA-Remote Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent SAKURA-Remote from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by SAKURA-Remote"),
        ("live_update_check", "Check for updates"),
        ("live_update_checking", "Checking..."),
        ("live_update_latest", "You are on the latest version"),
        ("live_update_failed", "Failed to check for updates"),
        ("live_update_available_title", "Update available"),
        ("live_update_available_msg", "A new version is available. Update now? The app will restart during the update."),
        ("live_update_now", "Update now"),
        ("live_update_started", "Update started. The app will restart shortly."),
        ("live_update_published_at", "Published"),
        ("live_update_changes", "Changes"),
        ("live_update_not_published", "The macOS update information has not been published yet"),
        ("live_update_development_only", "Development-only update packages cannot be installed"),
        ("live_update_signing_required", "LiveUpdate is unavailable in this unsigned test build. Install a signed release first"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if SAKURA-Remote window is open"),
        ...
        ("floating_window_tip", "It helps to keep SAKURA-Remote background service"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, SAKURA-Remote verifies the server certificate for protocols using TLS.\nWith this option enabled, SAKURA-Remote will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, SAKURA-Remote will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: SAKURA-Remote server OSS doesn't include this feature."),
